...
| Held-out policy-context robustness | `code/08_policy_context_robustness.py --seed 42 --min-rule-rows 50 --n-estimators 300 --max-depth 6 --device cpu` | `results/policy_context_robustness/policy_context_rule_summary.csv`, `policy_context_heldout_aggregate.csv`, `policy_context_heldout_results.csv`, `policy_context_heldout_confusions.csv`, `policy_context_robustness_metadata.json` |
