...
echo "paper1 vps all baseline started=${start_iso} ended=${end_iso} wall_seconds=$((end_epoch-start_epoch))" | tee "paper1_threat_xai_action/data/reports/run_vps_all_baseline_timing.txt"
